...
<p className=" text-center mt-3 text-blue-800">BrightVision  team building services in Saudi Arabia are designed to foster teamwork, build trust, and promote open</p>
<p className=" text-center  text-blue-800">communication among team members. Here  how we do it:</p>
    <TimelineComponent />
</div>
  );
}
